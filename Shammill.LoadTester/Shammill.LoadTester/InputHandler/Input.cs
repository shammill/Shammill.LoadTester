using Shammill.LoadTester.HttpClients;
using System;
...
namespace Shammill.LoadTester.InputHandler
{
    public static class Input
    {
        public static void Process()
        {
            ...
            int numberOfRequests = Convert.ToInt32(userInput.GetParameter(1));
            ...
            string payload = null;//GetJsonPayload();
            ...
            Console.WriteLine($"Getting {url} {numberOfRequests} times.");
